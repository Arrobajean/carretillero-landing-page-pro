...
const CtaSection = () => {
  return (
    <section
      id="cta-section"
      className="bg-primary py-20 relative overflow-hidden flex items-center justify-center min-h-screen"
    >
      <div
        className="absolute inset-0 bg-gradient-to-br from-primary via-primary to-primary z-10"
        style={{
          backgroundImage: "url('/images/landing/carretillero-cta.jpg')",
      ...
      <div className="container-section flex flex-col items-center justify-center text-center relative z-20">
        ...
        >
          ...
          <p className="text-lg text-white/90 mb-12">
            Contáctanos ahora y descubre cómo nuestros cursos certificados
            pueden ayudarte a conseguir mejores oportunidades laborales.
          </p>
