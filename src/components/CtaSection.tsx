...
const CtaSection = () => {
  return (
    <section id="cta-section" className="bg-primary py-20 relative overflow-hidden">
      <div 
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <motion.a
              ...
              className="btn-accent text-lg py-4 px-8 flex items-center justify-center gap-2"
            >
            ...
            <motion.a
              ...
              className="btn-outline border-white text-white text-lg py-4 px-8 flex items-center justify-center gap-2"
            >
              <Phone size={20} />
              Llámanos
            </motion.a>
