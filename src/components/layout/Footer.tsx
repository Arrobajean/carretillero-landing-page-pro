import { Phone, Mail, FileText, File, Cookie } from "lucide-react";
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center md:text-left">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Professional Categories SL
              <br />
              Expertos en formación de carretillas elevadoras y maquinaria.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 flex flex-col items-center md:items-start">
              ...
              <div className="flex items-center">
                ...
                <a
                  href="mailto:info@tucarretillero.com"
                  className="text-gray-400 hover:text-white transition-colors"
                >
                  info@tucarretillero.com
                </a>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="mt-2 space-y-2 text-sm">
                ...
                <div className="flex items-center justify-center md:justify-start">
                  <Cookie size={16} className="mr-2 text-accent" />
                  <Link
                    to="/politica-cookies"
                    className="text-gray-400 hover:text-white transition-colors"
                  >
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-gray-400 text-sm text-center">
            &copy; {currentYear} Professional Categories SL. Todos los derechos
            reservados.
          </p>
          ...
          <p className="text-gray-500 text-xs text-center mt-1">
            por Jean Paul Castañeda Huerta
          </p>
        </div>
      </div>
    </footer>
